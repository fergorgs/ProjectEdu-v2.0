export const data = [
	{
		...
		},
		{
			...
			IConceptImpl: [
			{
				...
				{
					id: Math.random(),
					subText: '- Temporary as it must have a formal start and end date;',
				},
				{
					id: Math.random(),
					subText: '- Product or Service indicates that the product or service to be delivered is different from all previous ones.',
				}, ],
			},
			{
				...
				{
					id: Math.random(),
					subText: '- Criação de um novo modelo de automóvel;',
				},
				{
					id: Math.random(),
					subText: '- Desenvolvimento de um software;',
				},
				{
					id: Math.random(),
					subText: '- Festa de casamento;',
				},
				{
					id: Math.random(),
		...
		},
		{
			...
			},
			{
				...
				{
					id: Math.random(),
					subText: '- Solicitações de compra;',
				},
				{
					id: Math.random(),
					subText: '- Atualizações do estoque;',
				}, ],
			}, ],
		},
		{
		...
		},
		{
			...
			},
			{
				...
				{
					id: Math.random(),
					subText: '- Unir profissionais da área de Gerenciamento de Projetos para trocarem experiências e conhecimentos;',
				},
				{
					id: Math.random(),
					subText: '- Identificar e reunir as melhores práticas em Gerenciamento de Projetos através de um guia;',
				},
				{
					id: Math.random(),
					subText: '- Estabelecer uma ética na profissão;',
				},
				{
					id: Math.random(),
					subText: '- Certificar profissionais da área.',
				}, ],
			},
			{
			...
			},
			{
				...
				{
					id: Math.random(),
					subText: '- Monitoramento e Controle;',
				},
				{
					id: Math.random(),
					subText: '- Encerramento.',
				}, ],
			},
			{
		...
		{
			id: Math.random(),
			text: '1) The life cycle of a product consists of the following phases: initiation, planning, execution, control, and closure.',
			exercices: [
			{
				id: Math.random(),
				subText: '1) False',
		...
		{
			id: Math.random(),
			text: '2) PMBOK defines a project as:',
			exercices: [
			{
				id: Math.random(),
				subText: 'a) A process of relevance and considerable risk to the organization that must be implemented following a tight budget.',
			},
			{
				id: Math.random(),
				subText: 'b) Um grupo de atividades gerenciado de forma coordenada para atingir um resultado desejado',
			},
			{
				id: Math.random(),
				subText: 'c) Um empreendimento temporário que tem por objetivo criar um produto ou serviço único',
			},
			{
				id: Math.random(),
				subText: 'd) Um conjunto de atividades que devem ser empreendidas obedecendo a procedimentos, custos e a prazos preestabelecidos',
			}, ],
		}, ],
	},
	{
	...
	{
		id: Math.random(),
		moduleContent: 'Itil V3',
		concepts: [
		{
			id: Math.random(),
			concept: 'Estratégia de serviço',
		},
		{
			id: Math.random(),
			concept: 'Portfólio de Serviço',
		},
		{
			id: Math.random(),
			concept: 'Gerenciamento Financeiro',
		}, ],
	},
	{
		id: Math.random(),
		moduleContent: 'Cobit 5',
		concepts: [
		{
			id: Math.random(),
			concept: 'Princípios',
			IConceptImpl: [
			{
				text: '1 - Satisfazer as necessidades das partes interessadas',
			},
			{
				text: '2 - Cobrir a organizaçao de ponta-a-ponta',
			},
			{
				text: '3 - Aplicar um framework integrado único',
			},
			{
				text: '4 - Possibilitar uma visão holística ',
			},
			{
				text: '5 - Separar Governança do Gerenciamento',
			}, ],
		},
		{
			id: Math.random(),
